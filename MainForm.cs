...
namespace WindowsFormsApp1
{
    public partial class MainForm : Form        // Define MainForm class that inherits from main Form class.
    {
        ...
        private double totalCost;               // Variable totalCost that is stores the calculated total cost.
               
        private void totalButton_Click(object sender, EventArgs e)
        {
            double dormCost = 0;                // Initial dormCost value is 0
            double mealCost = 0;                // Initial mealCost value is 0
